...
export function editorInstallSteps(editor) {
  ...
  if (editor.slug === 'vscode') {
    return ['Choose Install and allow VS Code to open.', 'Choose Go Live Now and approve GitHub.', 'See your verified GitHub name on the live globe.'];
  }
  return ['Download the latest VSIX and install it in your editor.', 'Choose Go Live Now and approve GitHub.', 'See your verified GitHub name on the live globe.'];
}
