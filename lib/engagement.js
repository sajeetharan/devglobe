...
const ACQUISITION_SOURCES = new Set([...SHARE_CHANNELS, 'direct', 'discord', 'external_referral', 'github_discussions', 'local', 'manual_outreach', 'other', 'search', 'search_button', 'search_enter', 'weekly_digest', 'weekly_spotlight']);
